...
import {
    ...
    PopoverContent,
    PopoverTrigger,
} from "../form-components/partial/popovercomponents";
...
import Reactbigcalendarcomponent from "./reactbigcalendarcomponent";
    ...
    return (
        <Popover>
            ...
            <PopoverContent  className="w-auto p-0 z-[70]">
                <Modal size="3xl" open={true} closeModal={() => void (0)}>
